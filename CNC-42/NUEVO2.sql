SELECT (SELECT ffvt.description
 ...
 WHERE prha.requisition_header_id = prla.requisition_header_id
   ...
   --AND prha.requisition_number = '11-RQ-00254'
 ...
 ORDER BY prha.requisition_number, prla.line_number
 ...
 SELECT
    ...
    SELECT COUNT(*) FROM (SELECT (SELECT ffvt.description
          FROM FND_FLEX_VALUE_SETS  ffvs,
               FND_FLEX_VALUES      ffv,
               FND_FLEX_VALUES_TL   ffvt
         WHERE ffvs.flex_value_set_name = 'CNC_CENTRO_DE_COSTO'
